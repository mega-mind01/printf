 ...
 * @flags: Flags used
 * @width: width derived
 * @prec: Precision input
 * @length: length
 * @padd: Pading char in function
 * @extra_c: Extra char for function use
 *
...
/**
 * write_unsgnd - Writes an unsigned number tp stdout
 * @is_negative: check for negative number
